...
function Page() {
  ...
  return (
    <div className='flex flex-col justify-center items-center h-[90vh] w-full font-[family-name:var(--font-geist-mono)]'>
      <div className='mb-8'>
        <h1 className='lg:text-2xl text-xl text-center font-semibold'>Verify your account</h1>
        <p className='text-[var(--paragraph)] text-[14px]'>Kindly verify your account to finish setup</p>
      </div>
